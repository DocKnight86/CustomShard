...
namespace Server.Mobiles
{
    ...
    public class PlayerVendor : Mobile
    {
        ...
        public int ChargePerRealWorldDay
        {
            get
            {
                ...
                MerchantsTrinket trinket = GetMerchantsTrinket();
    ...
    public class PayTimer : Timer
    {
        ...
        protected override void OnTick()
        {
            ...
            {
                PlayerVendor v = PlayerVendor.PlayerVendors[index];
            ...
            {
                PlayerVendor vendor = list[i];
                vendor.NextPayTime = DateTime.UtcNow + GetInterval();

                int pay = vendor.ChargePerRealWorldDay;
                int totalGold = vendor.HoldGold;
                ...
                else
                {
                    ...
                    MerchantsTrinket trinket = vendor.GetMerchantsTrinket();
            ...
            List<RentedVendor> rentals = new List<RentedVendor>();
