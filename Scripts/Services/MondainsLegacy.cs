...
namespace Server
{
    public static class MondainsLegacy
    {
        ...
        {
            typeof(BladeDance), typeof(BloodwoodSpirit), typeof(Bonesmasher),
            typeof(Boomstick), typeof(FleshRipper),
            typeof(PadsOfTheCuSidhe), typeof(QuiverOfRage), typeof(QuiverOfElements),
