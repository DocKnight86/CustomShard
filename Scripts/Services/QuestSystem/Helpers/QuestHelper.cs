...
namespace Server.Engines.Quests
{
    public class QuestHelper
    {
        ...
        {
            for (int index = 0; index < pm.DoneQuests.Count; index++)
            {
                QuestRestartInfo ri = pm.DoneQuests[index];
        ...
        {
            for (int index = 0; index < player.DoneQuests.Count; index++)
            {
                QuestRestartInfo x = player.DoneQuests[index];
        ...
        public static bool InProgress(PlayerMobile player, Type[] quests)
        {
            ...
            {
                BaseQuest q = player.Quests[i];

                bool any = false;

                for (int index = 0; index < quests.Length; index++)
                {
                    Type questerType = quests[index];
        ...
        public static bool InProgress(PlayerMobile player, Mobile quester)
        {
            ...
            for (int index = 0; index < player.Quests.Count; index++)
            {
                BaseQuest q = player.Quests[index];
        ...
        {
            for (int index = 0; index < pm.Quests.Count; index++)
            {
        ...
        public static bool CheckRewardItem(PlayerMobile player, Item item)
        {
            for (int index = 0; index < player.Quests.Count; index++)
            {
                ...
                for (int i = 0; i < quest.Objectives.Count; i++)
                {
                    ...
                    {
                        for (int index1 = 0; index1 < quest.Objectives.Count; index1++)
                        {
        ...
        public static T GetQuest<T>(PlayerMobile pm) where T : BaseQuest
        {
            ...
            for (int index = 0; index < pm.Quests.Count; index++)
            {
                BaseQuest quest = pm.Quests[index];
